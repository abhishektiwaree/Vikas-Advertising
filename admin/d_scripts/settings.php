...
// this code prepares the environment for potentially long-running and intensive tasks. It initializes a time tracking array, records the starting time, removes any time restrictions on script execution, and sets the error reporting level to be as comprehensive as possible. This combination of settings is often used for tasks that may take a considerable amount of time to complete, such as data processing, file operations, or complex calculations. till line 4-7
$time_track = array();
...
?>
		<div class="sidebar" data-color="" data-image="images/sidebar-6.jpg">
		<!--
			...
			<nav class="navbar navbar-expand-lg bg-dark text-white">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand page-title" href="#" style="font-size:24px; color:white"><?php echo $GLOBALS['title']; ?></a>
                    </div>
